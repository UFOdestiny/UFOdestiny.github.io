...
- **Generative models for urban and energy data.** Diffusion models that synthesize or repair mobility traces, human activity, utility readings, and patient health records when real data is scarce, private, or incomplete ([SynHAT](/publications/#xu2026synhat), [MobiDiff](/publications/#xu2026mobidiff), [MBDiff](/publications/#xu2026mbdiff), [SynEnergy](/publications/#jiang2026synenergy), [E4GEN](/publications/#jiang2026e4gen), [ZeroHAT](/publications/#xu2026zerohat), [SynEHR](/publications/#li2026synehr)).
- **Uncertainty quantification for LLM reasoning.** Estimating when a fluent reasoning trace should be trusted, using answer re-elicitation, symbolic verification, and reasoning-chain consistency ([TrAC](/publications/#yu2026trac), [SymboUQ](/publications/#yu2026symbouq), [ChainUQ](/publications/#yu2026chainuq)).
- **From prediction to decisions.** Predict-then-optimize pipelines where the uncertainty estimate actually changes the allocation — e.g. [equitable post-disaster power restoration](/publications/#jiang2025epopr) — and the measurement that tells planners where to act, such as [healthcare accessibility and resilience in the rural Florida Panhandle](/publications/#yu2026ruralhealth).

My work has appeared at NeurIPS, AAAI, IJCAI, ACM SIGKDD, ACM SIGSPATIAL, ACM CIKM, and ACM IMWUT (UbiComp), and I received the **Dean's Award for Doctoral Excellence** from Florida State University in 2026, and the **Challenge Cup Second Prize** and a **Third Prize Scholarship** at Peking University. I am always happy to talk about spatiotemporal foundation models, calibration, or urban data — feel free to reach out.
